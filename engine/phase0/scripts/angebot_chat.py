...
def beschreibung_zu_angebot(text: str) -> Angebot:
    ...
    msg = c.messages.create(
        ...
        messages=[{"role": "user", "content":
                   ...
                   f"der Vergangenheit. Fehlt im Datum das Jahr "
                   f"(z.B. 'Party am 18. Juni'), ergänze IMMER das "
                   f"laufende Jahr {h.year} (bzw. {h.year + 1}, falls "
                   f"der Tag/Monat dieses Jahr schon vorbei ist).\n"
