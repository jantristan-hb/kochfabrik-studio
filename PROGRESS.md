...
**Aktueller Sprint:** Sprint 2 DONE (EPIC-001 Angebotsgenerator)
**Status:** 2 Sprints done, 12 Stories · Sprint 2: 6/6 DONE
...
|----|-------|--------|---------|
| EPIC-001 | KOCHfabrik Angebotsgenerator (Chat → pixelgenaues Angebots-PDF) | IN_PROGRESS | Sprint 2 DONE · 3–5 offen |
