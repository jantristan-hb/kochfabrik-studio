...
**Aktueller Sprint:** Sprint 2 TODO (EPIC-001 Angebotsgenerator)
**Status:** 1 Sprint done, 6 Stories · Sprint 2 geplant (6 Stories)
...
| Story | Titel | Status |
|-------|-------|--------|
| US-007 | Angebots-Korpus inventarisieren & Layout vermessen | TODO |
| US-008 | Angebots-Datenmodell definieren | TODO |
| US-009 | Template aus Referenz-Muster pixelgenau extrahieren | TODO |
| US-010 | Datenmodell → Template Felder-Mapping | TODO |
| US-011 | Positionsblock-Struktur modellieren | TODO |
| US-012 | kf_classify-Konformitäts-Check | TODO |
...
|----|-------|--------|---------|
| EPIC-001 | KOCHfabrik Angebotsgenerator (Chat → pixelgenaues Angebots-PDF) | IN_PROGRESS | Sprint 2 geplant · 3–5 grob |
